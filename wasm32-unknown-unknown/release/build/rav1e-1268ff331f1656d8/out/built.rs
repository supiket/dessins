...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.84.1 (e71f9a9a9 2025-01-27) (built from a source tarball)";
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.84.1 (e71f9a9a9 2025-01-27) (built from a source tarball)";
